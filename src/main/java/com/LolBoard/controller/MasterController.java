...
import com.LolBoard.service.MasterService;
...
public class MasterController {
	...
	public void getMembermanage(Model model) {
		model.addAttribute("count", service.memberNumber());
		model.addAttribute("member", service.memberInfo());
	}
	
	//글 관리 화면 보기
	@GetMapping("/master/boardmanage")
	public void getBoardmanage(Model model) {
		model.addAttribute("count", service.boardNumber());
		model.addAttribute("board", service.boardInfo());
	}
