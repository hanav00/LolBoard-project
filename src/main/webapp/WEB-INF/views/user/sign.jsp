...
<script>
	...
	function register() { 
		...
		//유효성 검사
		const userid = document.querySelector("#userid");
		if(userid.value == '') {Swal.fire("Enter your ID"); userid.focus(); return false;}
		
		const username = document.querySelector("#username");
		if(username.value == '') {Swal.fire("Enter your ID"); username.focus(); return false;}

		const Pass = $("#password").val();
		const Pass1 = $("#password1").val();
		if(Pass == '') { Swal.fire("Enter your password"); $("#password").focus(); return false; }
		if(Pass1 == '') { Swal.fire("Enter your password"); $("#password1").focus(); return false; }
		if(Pass != Pass1) 
			{ Swal.fire("Enter your password correctly"); $("#password1").focus(); return false; }
		...
		Swal.fire({
			  title: 'Will you sign up?',
			  text: "You can't change your ID, name, and gender if you sign in.",
			  icon: 'question',
			  showCancelButton: true,
			  confirmButtonText: 'Yes, I will',
			  cancelButtonText: 'Wait, I want to change',
			  reverseButtons: true
			}).then((result) => {
			  if (result.isConfirmed) {
			    Swal.fire(
			      ...
			      'success'
			    	...
			    	$("#RegistryForm").attr("action","/user/sign").submit();
			    }); 
                    ...
                    <form method="POST" id="RegistryForm" class="RegistryForm">
                        ...
                        <div class="form-row">
                            <div class="form-group form-icon">
                                <label for="birth_date">Birth date</label> (Should be YYYY-MM-DD)
							...
							<div class="form-row">
                                ...
                                <div class="form-group">
									<label for="country">Country</label> (Click and search your country)
									    <input list="country" id="country1" name="country" class="dropdown" value="Find your country" style="font-family: 'Montserrat'; font-weight:lighter;">
                    ...
                    <div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
								<input type="button" class="login100-form-btn" onclick="return register()" value="Sign Up!">
						</div>
						</div>
