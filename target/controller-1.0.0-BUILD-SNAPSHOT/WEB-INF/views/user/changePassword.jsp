...
async function changePassword(){
	...
	if(Pass != Pass1) 
		{ swal("Enter your new password correctly"); $("#password1").focus(); return false; }
...
<form name="PasswordForm" id="PasswordForm" method="post">
		...
		<p style="text-align:center">${passwordTime} days have passed since you changed your password.<br>You should change your password after thirth days!</p>
							<br><br>
